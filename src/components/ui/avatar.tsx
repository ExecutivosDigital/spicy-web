        ...
        {avatars.length > max && (
          <>
            {custom ? (
              ...
              <Avatar
                className={cn(
                  "ring-background ring-offset-background ring-1 ring-offset-[2px]",
                  countClass,
                )}
              >
...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn(
      "bg-muted flex h-full w-full items-center justify-center rounded-full font-semibold lg:text-[7px] xl:text-sm",
      className,
    )}
    {...props}
  />
