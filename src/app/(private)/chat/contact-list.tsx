...
const ContactList = ({
  ...
  return (
    <div
      className={cn(
        "hover:bg-default-200 flex cursor-pointer border-l-2 border-transparent px-3 py-2 lg:max-w-[250px] lg:min-w-[250px] lg:gap-2 lg:px-2 lg:py-1 xl:max-w-[350px] xl:min-w-[350px] xl:gap-4 xl:px-3 xl:py-2",
        // {
